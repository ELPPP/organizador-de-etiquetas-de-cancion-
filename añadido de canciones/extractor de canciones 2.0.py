...
if e== False:
    nombre="Canciones UWU.xlsx"
    cr.creacion(nombre)
else:
    print("el archivo existe uWu")

#extraccion de la ruta
ruta = 'S:\Musica\Musica\salvar\conservar.mp3'
...
for f in h:
    ...
    for C in F:
        ...
        Archivo=op.load_workbook("Canciones UWU.xlsx")
        Libro=Archivo['Sheet'] 
        P=Libro['A1']
        p=P.value
        print("vriabilizando datos")
        p = str(p)
        e1 = "B" + p
        e2 = "C" + p
        e3 = "D" + p
