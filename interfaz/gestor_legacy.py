...
class GestorScreen(Screen):
    ...
    def rellena_izquierda(self, llave: dict):
        print("rellena izquierda llamado")
        fila = self._crear_fila(llave)
        print("fila izquierda creada")
        tabla= self.layout.ids.tabla_izquierda
        tabla.add_widget(fila)
        tabla.height=tabla.minimum_height
        #self.layout.ids.tabla_izquierda.add_widget(fila)
        print("fila añadida a la tabla izquierda")
    ...
    def rellena_derecha(self, llave: dict):
        ...
        fila = self._crear_fila(llave)
        print("fila izquierda creada")
        tabla= self.layout.ids.tabla_derecha
        tabla.add_widget(fila)
        tabla.height=tabla.minimum_height
        #self.layout.ids.tabla_izquierda.add_widget(fila)
        print("fila añadida a la tabla izquierda")
